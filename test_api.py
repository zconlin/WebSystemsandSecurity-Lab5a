...
class TestAPI(unittest.TestCase):
    ...
    # base_url, cookie = "https://210s1.itcyber.byu.edu", "s%3A3t..." # For s1
    # base_url, cookie = "https://210s2.itcyber.byu.edu", "s%3Adq..." # For s2
    # base_url, cookie = "https://210s3.itcyber.byu.edu", "s%3A-t..." # For s3
    # base_url, cookie = "https://210s4.itcyber.byu.edu", "s%3AJi..." # For s4
